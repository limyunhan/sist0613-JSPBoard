...
if (flag) freeBbsRecomDao.freeBbsRecomInsert(userId, freeBbsSeq);
else freeBbsRecomDao.freeBbsRecomDelete(userId, freeBbsSeq);
int newCount = freeBbsRecomDao.getFreeBbsRecomCnt(freeBbsSeq);

// JSON 응답 생성
StringBuilder jsonResponse = new StringBuilder();
jsonResponse.append("{\"flag\": ").append(flag).append(", \"newCount\": ").append(newCount).append("}");
