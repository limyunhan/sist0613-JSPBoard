...
<%
Logger logger = LogManager.getLogger("freeWriteSubCom.jsp");
...
if (freeBbsComSeq > 0 && !StringUtil.isEmpty(freeBbsComContent)) {
	...
	if(freeBbsCom != null) {
		...
		if (freeBbsComDao.subFreeBbsComInsert(freeBbsCom)) {
			flag = false;
